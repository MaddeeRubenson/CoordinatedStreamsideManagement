...
title: '<img src="LogoColorRegular.jpg" style="float: right;width: 80px; "/> Oregon
  DEQ Water Quality Status and Trends report for the Camp Creek Strategic Implementation Area and Coordinated Streamside Management'
author: ''
date: "January 2018"
output:
  html_document:
...
df.all <- read.csv('Data/17090004 - McKenzie_df.sub.csv')
...
SIA <-  SIA[SIA$HU12_Name == "Camp Creek",]
...
input$select <- 'Southern Willamette Valley'
...
##- Station Locations 
Within the Camp Creek SIA boundary, no monitoring stations fit the criteria to assess water quality status and trends. The following map shows monitoring stations that have data within the SIA boundary. Use the box on the right side of the figure to choose between layers displayed.
...
wq_limited_df <- wq_limited_df %>% filter(Waterbody == "Camp Creek")
